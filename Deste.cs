...
namespace Pisti
{
    public class Deste
    {
        //[]: Dizi operatörü. Belirlenmiş veri tipindeki birden fazla değerin taşınmasını sağlayan yapılardır. Her bir değer için bir adres oluşturur. Bu adres 0'dan başlar. Ya dizi boyut verilerek boş olarak tanımlanır yada değerler direk gönderilerek.
        //public Kart[] Kartlar;

        //List<>: Belirlenmiş veri tipinde boyutu değiştirilebilir (ekleme/silme) bir yapıdır. Önceden bir boyut belirtilmez. Generic (Genel kullanım) amaçlıdır. '<' ve '>' işaretleri arasına veri tipi yazılır.
